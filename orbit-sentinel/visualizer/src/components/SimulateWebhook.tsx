    ...
    <div className="card" style={{
      ...
      {completed && (
        <div style={{
          ...
          <span>Flow complete in <strong style={{ color: "#22c55e" }}>{(steps.length * 0.7).toFixed(1)}s</strong> — <strong style={{ color: "var(--accent-blue)" }}>Navigate the tabs above</strong> to explore the full analysis.</span>
        </div>
      )}
    </div>
  );
