...
const TOUR_STEPS: TourStep[] = [
  ...
  { icon: "🏁", title: "You've Seen the Future of MR Review", subtitle: "Explore freely", description: "You've seen all 10 steps. Here's what you just witnessed: a digital twin built from all 4 Orbit query types, interactive what-if simulation, historical intelligence with 90% pattern accuracy, and a deploy/no-deploy verdict with evidence — in seconds. Not one line of your CI pipeline changed.", focus: "Hit 'Explore Dashboard' to navigate freely. Press Space for auto-demo, arrow keys to switch views, and ⬇ to export. This is production-ready engineering decision intelligence." },
];
