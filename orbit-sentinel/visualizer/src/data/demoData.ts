...
export const DEMO_DATA: VisualizationData = {
  ...
  evidence: [
    ...
    { queryType: "TRAVERSAL", queryName: "Historical Similarity", result: "50+ historical MRs from test-sentinel branch\nOnly MR !1 merged (2024); MRs !2–!9 all closed without merge\nAbandonment pattern: 90% closure rate across last 10 MRs" },
